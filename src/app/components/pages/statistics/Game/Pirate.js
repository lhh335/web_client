...
class Corsail extends Component {
    state = {
        data: [],
        seat: [],
        deskSeats: [],
            ...
            <div >
                ...
                <ReactDataGrid
                    ...
                    columns={[
                        ...
                        {
                            key: 'total_earn',
                            name: this.state.earnStyle === 'drawWaterEarn' ? "总盈利(含抽水)" : '总盈利(不含抽水)',
                            resizable: true,
                        },
                        {
                            key: 'earn_rate',
                            name: this.state.earnStyle === 'drawWaterEarn' ? "盈利比(含抽水)" : '总盈利(不含抽水)',
                            resizable: true
                        },
                    ...
                    rowGetter={(i) => {
                        ...
                        return {
                            room: Lang[window.Lang].Setting.GamePage[15].room[this.state.data[i].room],
                            ...
                            game_df: Lang[window.Lang].Setting.GamePage[15].game_df[this.state.data[i].game_df],
                            hall_type: Lang[window.Lang].Setting.GamePage[15].hall_type[this.state.data[i].hall_type],
                ...
                {apptype === 2 ?
                    <ReactDataGrid
                        ...
                        rowGetter={(i) => {
                            ...
                            return {
                                room: Lang[window.Lang].Setting.GamePage[15].room[this.state.deskSeats[i].room],
