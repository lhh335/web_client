        ...
        return (
            <div>
                {sessionStorage.accountType === '0' ?
                    <Title render={(previousTitle) => `${Lang[window.Lang].Statistics.Game.fish} - ${Lang[window.Lang].Statistics.desks} - ${previousTitle}`} /> :
                    <Title render={(previousTitle) => `${Lang[window.Lang].Statistics.Game.fish} - 超级管理员后台`} />
                }
                ...
                <ReactDataGrid
                    ...
                    columns={[
                        ...
                        {
                            key: 'earn_rate',
                            name: this.state.earnStyle === 'drawWaterEarn' ? "盈利比(含抽水)" : '盈利比(不含抽水)',
                            resizable: true
                        },
