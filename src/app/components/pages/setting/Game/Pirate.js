...
export default class PirateGame extends React.Component {
    errorMessages = {
    ...
    render() {
        return (
            <Paper>
                <Title render={(previousTitle) => `${Lang[window.Lang].Statistics.Game.pirate} - ${Lang[window.Lang].Setting.game} - ${previousTitle}`} />
                ...
                <ReactDataGrid
                    ...
                    rowGetter={(i) => {
                        ...
                        return {
                            room: Lang[window.Lang].Setting.GamePage[15].room[this.state.tilesData[i].room],
                ...
                {this.state.selectedOne === undefined ? "" :
                    ...
                    >
                        <CardHeader
                            ...
                            title={Lang[window.Lang].Setting.GamePage[15].room[this.state.singleDeskInfo.room] + '--' + this.state.singleDeskInfo.name}
