...
export default class BullGame extends React.Component {
    errorMessages = {
        ...
        return (
            <div>
                <Paper style={{ marginTop: 10, paddingTop: 3, paddingBottom: 10 }}>
                    <h5>{Lang[window.Lang].Setting.GamePage[12].room[this.state.singleDeskInfo.room] + '--' + this.state.singleDeskInfo.name + '--抽水设置'}</h5>
                    <Divider />
                    <TextField
                ...
                <Paper style={this.paperStyle}>
                    ...
                    >
                        ...
                        <TextField
                            ...
                            defaultValue={this.state.type === 'modify' ? this.getDeskSetting(this.state.currentDesk).consume[0] : "1000"}
                        />
                        <TextField
                            middleWidth={true}
                            style={Styles.selecteField2}
                            ...
                            name="consume_max"
                            hintText="请输入最大炮数,不能超过10000"
                            floatingLabelText="最大炮数"
                            defaultValue={this.state.type === 'modify' ? this.getDeskSetting(this.state.currentDesk).consume[1] : "9900"}
                        />
                        <TextField
                            middleWidth={true}
                            style={Styles.selecteField2}
                            ...
                            defaultValue={this.state.type === 'modify' ? this.getDeskSetting(this.state.currentDesk).step : "500"}
                        />
                        <TextField
                            middleWidth={true}
                            style={Styles.selecteField2}
                        ...
                        <TextField
                            ...
                            defaultValue={this.state.type === 'modify' ? this.getDeskSetting(this.state.currentDesk).exchange_rate : "1000"}
                        />
    ...
    render() {
        return (
            <Paper>
                <Title render={(previousTitle) => `${Lang[window.Lang].Statistics.Game.bull} - ${Lang[window.Lang].Setting.game} - ${previousTitle}`} />
                ...
                <ReactDataGrid
                    ...
                    onRowClick={(rowIdx, row) => {
                        ...
                        this.setState({ selectedOne: rowIdx, singleDeskInfo: this.state.tilesData[rowIdx], input_pumpingValue: '', openPumping: false })
                        if (this.state.singleDeskInfo === undefined) {
                            this.state.selectedOne === undefined;
                ...
                {this.state.selectedOne === undefined ? "" :
                    ...
                    >
                        <CardHeader
                            ...
                            title={Lang[window.Lang].Setting.GamePage[12].room[this.state.singleDeskInfo.room] + '--' + this.state.singleDeskInfo.name}
