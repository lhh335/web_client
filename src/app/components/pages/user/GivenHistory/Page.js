    ...
    render() {
        ...
        return (
            <div>
                ...
                <CommonTable
                    table={Lang[window.Lang].User.GivenPage.Table}
                ...
                <div style={Styles.totalApproveAndRefuse}>
                    <h5 style={Styles.fontLeftFloat}>总赠送:{this.state.total_approved}元</h5>
                </div>
...
class UserGivenHistory extends Component {
    constructor(props) {
        super(props);
    }
    render() {
...
export default UserGivenHistory;
