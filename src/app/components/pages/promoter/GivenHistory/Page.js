        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <CommonTable
                        table={Lang[window.Lang].Promoter.GivenPage.Table}
                ...
                <div style={Styles.totalApproveAndRefuse}>
                    <h5>总赠送:{this.state.total_approved}元</h5>
                </div>
...
class PromoterGivenHistory extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        return (
            <div>
                <Title render={(previousTitle) => `推广员赠送历史 - ${previousTitle}`} />
                <PageComplex promoter={this.props.promoter} />
            </div>
        )
    }
}
export default PromoterGivenHistory;
