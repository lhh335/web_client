import {QUERY_PROMOTER_RECHARGE_HISTORY_C2S,QUERY_PROMOTER_RECHARGE_HISTORY_S2C,} from "../../../../proto_enum";
...
class PageComplex extends React.Component {
  ...
  queryRecharge = () => {
    ...
    var cb = (id = 0, message = null, args) => {
      ...
      self.setState({ cData: message.cri, totalPage: Util.page.getTotalPage(message.count) });
    ...
    MsgEmitter.emit(QUERY_PROMOTER_RECHARGE_HISTORY_C2S, obj, cb, [this]);
  }
  ...
  insertDetail = () => {
    ...
    for (var key in table) {
      if (key !== "invalid_time" && key !== "end_time") {
        ...
        if (this.state.singleInfo.approve === 1 && key === "end_time") {
          list.push(
            <ul key={key}>
              <li>
      ...
      <div>
        {this.state.cData !== [] ?
          <div>
            ...
            >
              ...
              >
                <TableRow>
                  <TableHeaderColumn colSpan="49" tooltip={Lang[window.Lang].Coin.ChargePage.table_title1} style={{ textAlign: 'center' }}>
                    {Lang[window.Lang].Coin.ChargePage.table_title1}
                  </TableHeaderColumn>
                </TableRow>
                {
                  this.state.showCol === "all" ?
                    <TableRow>
                      <TableHeaderColumn colSpan="8" tooltip="The Order_ID">{Lang[window.Lang].User.ChargePage.Table.order_id}</TableHeaderColumn>
                      <TableHeaderColumn colSpan="6" tooltip="The Account">{Lang[window.Lang].User.ChargePage.Table.account}</TableHeaderColumn>
                      <TableHeaderColumn colSpan="5" tooltip="The User_ID">{Lang[window.Lang].User.ChargePage.Table.id}</TableHeaderColumn>
                      <TableHeaderColumn colSpan="5" tooltip="The RMB">{Lang[window.Lang].User.ChargePage.Table.rmb}</TableHeaderColumn>
                      <TableHeaderColumn colSpan="5" tooltip="The Approve">{Lang[window.Lang].User.ChargePage.Table.approve}</TableHeaderColumn>
                      <TableHeaderColumn colSpan="10" tooltip="The Time">{Lang[window.Lang].User.ChargePage.Table.time}</TableHeaderColumn>
                    ...
                    : <TableRow>
                      <TableHeaderColumn colSpan="16" tooltip="The Account">{Lang[window.Lang].User.ChargePage.Table.account}</TableHeaderColumn>
                      <TableHeaderColumn colSpan="16" tooltip="The RMB">{Lang[window.Lang].User.ChargePage.Table.rmb}</TableHeaderColumn>
                      <TableHeaderColumn colSpan="17" tooltip="The Approve">{Lang[window.Lang].User.ChargePage.Table.approve}</TableHeaderColumn>
                    </TableRow>
                }
              </TableHeader>
              <TableBody
                ...
                {this.state.cData.map((row, index) => (
                  this.state.showCol === "all" ?
                    <TableRow key={index} selectable={row.selected}>
                      <TableRowColumn colSpan="8">{row.order_id}</TableRowColumn>
                      <TableRowColumn colSpan="6">{row.account}</TableRowColumn>
                      <TableRowColumn colSpan="5">{row.id}</TableRowColumn>
                      <TableRowColumn colSpan="5">{row.rmb}</TableRowColumn>
                    ...
                    <TableRow key={index} selectable={row.approve === 1 && Util.time.getTimeSecond() < row.invalid_time}>
                      ...
                      <TableRowColumn colSpan="16">{row.rmb}</TableRowColumn>
        ...
        <div>
          ...
          >
            ...
            >
              <TableRow>
                <TableHeaderColumn colSpan="49" tooltip={Lang[window.Lang].Coin.ChargePage.table_title2} style={{ textAlign: 'center' }}>
                  {Lang[window.Lang].Coin.ChargePage.table_title2}
                </TableHeaderColumn>
              </TableRow>
              {
                this.state.showCol === "all" ?
...
const UserCharge = () => (
  <div>
    <Title render={(previousTitle) => `${Lang[window.Lang].Coin.chargeHistory} - ${previousTitle}`} />
    <PageComplex />
  </div>
);
